...
const Hero: React.FC = () => {
  ...
  // Animation for the dynamic background (if you want to keep the particles)
  useEffect(() => {
    const canvas = canvasRef.current;
    if (!canvas) return;
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 bg-cover bg-center" style={{ backgroundImage: 'url(/public/futuristic-background.jpg)' }}></div>
      ...
      <div className="relative w-40 h-40 mx-auto">
        <img src="../public/me.jpeg" alt="me" className="absolute bottom-3 left-1/2 -translate-x-1/2 bg-black bg-opacity-50 text-white text-xs rounded-full"/>
      </div>
